...
class GeneticAlgorithm(object):
	...
	'''
	def __init__(self, speciesCharac, fitnessFunct, showInfo = lambda a,c: 0, nbrOfGenerations = 100, populationSize = 40, tournamentSize = 2, selectionRate = 0.50, crossoverProb = 0.50, mutationProba = 0.01, elitisme = 0.025):
...
class GeneticAlgorithmVariation(GeneticAlgorithm):
	...
	def __init__(self, speciesCharac, fitnessFunct, showInfo = lambda a,b,c: 0, nbrOfGenerations = 100, populationSize = 40, tournamentSize = 2, selectionRate = 0.50, crossoverProb = 0.50, elitisme = 0.125, mutationVariation = 510000, mutationStart = 0.05, power = 2.2):
